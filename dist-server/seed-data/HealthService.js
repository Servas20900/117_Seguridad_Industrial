...
exports.occupationalHealthServices = void 0;
exports.occupationalHealthServices = [
    {
        ...
        modality: 'En sitio',
        scope: 'Programas de formaci├│n orientados a la prevenci├│n de riesgos laborales, fortaleciendo la cultura de seguridad y bienestar dentro de la organizaci├│n.',
        includes: [
    ...
    },
    {
        ...
        scope: 'Asesor├¡a profesional brindada por Ingenieros en Salud y Seguridad Ocupacional, Prevencionistas y Gestores Ambientales.',
        includes: [
    ...
    },
    {
        ...
        modality: 'En sitio',
        scope: 'Desarrollo de planes integrales ajustados a las necesidades reales de cada organizaci├│n.',
        includes: [
    ...
    },
    {
        ...
        modality: 'En sitio',
        scope: 'Evaluaci├│n t├⌐cnica de las condiciones laborales para identificar factores que afectan la salud del trabajador.',
        includes: [
