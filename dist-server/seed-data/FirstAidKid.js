...
exports.firstAidKits = void 0;
exports.firstAidKits = [
    {
        id: 'botiquin-primeros-auxilios',
        title: 'Botiqu├¡n de Primeros Auxilios',
        category: 'Equipamiento de Emergencias',
        description: 'Botiqu├¡n dise├▒ado para la atenci├│n inicial de emergencias, permitiendo una respuesta r├ípida, segura y organizada ante incidentes laborales.',
        contents: [
            {
